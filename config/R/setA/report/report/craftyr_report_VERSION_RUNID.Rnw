...
simp$sim$runids 	<- c("1-0")			# run to deal with
simp$sim$id			<- "1-0"		 	# ID to identify specific data collections (e.g. regions)
simp$sim$task		<- "1-0"			# Name of surrounding folder, usually a description of task 
aftParamId			<- 0
